...
// include: C:\Users\kryso\AppData\Local\Temp\tmpn_llmewg.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'Tengai-7857f792.data';
      var REMOTE_PACKAGE_BASE = 'Tengai-7857f792.data';
...
Module['FS_createPath']("/", "assets", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['FS_createDataFile'](name, null, data, true, true, true);
          ...
          Module['removeRunDependency']('datafile_Tengai-7857f792.data');
      }
      Module['addRunDependency']('datafile_Tengai-7857f792.data');
...
function findWasmBinary() {
  return locateFile('Tengai-7857f792.wasm');
}
