...
// include: C:\Users\kryso\AppData\Local\Temp\tmps52svkmo.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'Tengai-b2387755.data';
      var REMOTE_PACKAGE_BASE = 'Tengai-b2387755.data';
...
Module['FS_createPath']("/", "assets", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['FS_createDataFile'](name, null, data, true, true, true);
          ...
          Module['removeRunDependency']('datafile_Tengai-b2387755.data');
      }
      Module['addRunDependency']('datafile_Tengai-b2387755.data');
...
function findWasmBinary() {
  return locateFile('Tengai-b2387755.wasm');
}
