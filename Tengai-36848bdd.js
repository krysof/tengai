...
// include: C:\Users\kryso\AppData\Local\Temp\tmpc2c6r4wf.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'Tengai-36848bdd.data';
      var REMOTE_PACKAGE_BASE = 'Tengai-36848bdd.data';
...
Module['FS_createPath']("/", "assets", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['FS_createDataFile'](name, null, data, true, true, true);
          ...
          Module['removeRunDependency']('datafile_Tengai-36848bdd.data');
      }
      Module['addRunDependency']('datafile_Tengai-36848bdd.data');
...
function findWasmBinary() {
  return locateFile('Tengai-36848bdd.wasm');
}
