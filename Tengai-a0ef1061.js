...
// include: C:\Users\kryso\AppData\Local\Temp\tmpbmopmsaf.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'Tengai-a0ef1061.data';
      var REMOTE_PACKAGE_BASE = 'Tengai-a0ef1061.data';
...
Module['FS_createPath']("/", "assets", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['FS_createDataFile'](name, null, data, true, true, true);
          ...
          Module['removeRunDependency']('datafile_Tengai-a0ef1061.data');
      }
      Module['addRunDependency']('datafile_Tengai-a0ef1061.data');
    ...
    loadPackage({"files": [{"filename": "/assets/character-select-scene-data.bin", "start": 0, "end": 5696}, {"filename": "/assets/character-select-visual-data.bin", "start": 5696, "end": 11734}, {"filename": "/assets/player-control-data.bin", "start": 11734, "end": 11934}, {"filename": "/assets/player-profile-data.bin", "start": 11934, "end": 12172}, {"filename": "/assets/player-status-display-data.bin", "start": 12172, "end": 12324}, {"filename": "/assets/runtime-input-credit-data.bin", "start": 12324, "end": 12446}, {"filename": "/assets/runtime-join-frontend-data.bin", "start": 12446, "end": 12532}, {"filename": "/assets/runtime-player-primary-shot-data.bin", "start": 12532, "end": 18746}, {"filename": "/assets/runtime-player-stage-data.bin", "start": 18746, "end": 19700}, {"filename": "/assets/runtime-player-start-data.bin", "start": 19700, "end": 19794}, {"filename": "/assets/runtime-random-data.bin", "start": 19794, "end": 19844}, {"filename": "/assets/runtime-stage-data.bin", "start": 19844, "end": 20346}, {"filename": "/assets/runtime-stage-order-data.bin", "start": 20346, "end": 20424}, {"filename": "/assets/runtime-stage-palette-data.bin", "start": 20424, "end": 46888}, {"filename": "/assets/runtime-stage-tilemap-data.bin", "start": 46888, "end": 49492}, {"filename": "/assets/runtime-stage1-boss-assembly-data.bin", "start": 49492, "end": 56982}, {"filename": "/assets/runtime-stage1-boss-entrance-data.bin", "start": 56982, "end": 59458}, {"filename": "/assets/runtime-stage1-completion-presentation-data.bin", "start": 59458, "end": 59848}, {"filename": "/assets/runtime-stage1-curved-wave-data.bin", "start": 59848, "end": 60424}, {"filename": "/assets/runtime-stage1-first-wave-data.bin", "start": 60424, "end": 62496}, {"filename": "/assets/runtime-stage1-late-formations-data.bin", "start": 62496, "end": 63546}, {"filename": "/assets/runtime-stage1-midboss-data.bin", "start": 63546, "end": 65642}, {"filename": "/assets/runtime-stage1-post-midboss-data.bin", "start": 65642, "end": 66470}, {"filename": "/assets/runtime-stage1-rising-enemy-data.bin", "start": 66470, "end": 66698}, {"filename": "/assets/runtime-stage1-second-wave-data.bin", "start": 66698, "end": 67290}, {"filename": "/assets/runtime-stage1-third-wave-data.bin", "start": 67290, "end": 67534}, {"filename": "/assets/runtime-title-scene-data.bin", "start": 67534, "end": 72264}, {"filename": "/assets/sprite-lut.bin", "start": 72264, "end": 334464}, {"filename": "/assets/sprites.bmp", "start": 334464, "end": 6626038}, {"filename": "/assets/tiles.bmp", "start": 6626038, "end": 10820460}], "remote_package_size": 10820460});

  })();

// end include: C:\Users\kryso\AppData\Local\Temp\tmpbmopmsaf.js
// include: C:\Users\kryso\AppData\Local\Temp\tmp86s8_cfk.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\kryso\AppData\Local\Temp\tmp86s8_cfk.js
// include: C:\Users\kryso\AppData\Local\Temp\tmpyh45otl8.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\kryso\AppData\Local\Temp\tmpyh45otl8.js
...
function findWasmBinary() {
  return locateFile('Tengai-a0ef1061.wasm');
}
...
function present_rgba(pixels,width,height,presented_frames,selected_character,countdown,player_x,player_y,player_ready,primary_projectiles,enemies,credits,showing_title,stage_tick,midboss_active,midboss_x,midboss_y,midboss_children,post_midboss_active,post_midboss_x,post_midboss_y,post_midboss_children,boss_active,boss_x,boss_y,boss_frame,boss_core_active,boss_core_x,boss_core_y,boss_core_frame,boss_attachment_count,boss_anchor_x,boss_anchor_y,boss_anchor_frame,boss_overlay_x,boss_overlay_y,boss_overlay_frame) { const canvas = Module.canvas; const context = canvas.getContext('2d', {alpha: false}); const bytes = new Uint8ClampedArray( HEAPU8.buffer, pixels, width * height * 4); context.putImageData(new ImageData(bytes.slice(), width, height), 0, 0); canvas.dataset.primaryProjectiles = String(primary_projectiles); canvas.dataset.enemies = String(enemies); canvas.dataset.credits = String(credits); canvas.dataset.showingTitle = String(showing_title); canvas.dataset.stageTick = String(stage_tick); canvas.dataset.midbossActive = String(midboss_active); canvas.dataset.midbossX = String(midboss_x); canvas.dataset.midbossY = String(midboss_y); canvas.dataset.midbossChildren = String(midboss_children); canvas.dataset.postMidbossActive = String(post_midboss_active); canvas.dataset.postMidbossX = String(post_midboss_x); canvas.dataset.postMidbossY = String(post_midboss_y); canvas.dataset.postMidbossChildren = String(post_midboss_children); canvas.dataset.bossActive = String(boss_active); canvas.dataset.bossX = String(boss_x); canvas.dataset.bossY = String(boss_y); canvas.dataset.bossFrame = String(boss_frame); canvas.dataset.bossCoreActive = String(boss_core_active); canvas.dataset.bossCoreX = String(boss_core_x); canvas.dataset.bossCoreY = String(boss_core_y); canvas.dataset.bossCoreFrame = String(boss_core_frame); canvas.dataset.bossAttachmentCount = String(boss_attachment_count); canvas.dataset.bossAnchorX = String(boss_anchor_x); canvas.dataset.bossAnchorY = String(boss_anchor_y); canvas.dataset.bossAnchorFrame = String(boss_anchor_frame); canvas.dataset.bossOverlayX = String(boss_overlay_x); canvas.dataset.bossOverlayY = String(boss_overlay_y); canvas.dataset.bossOverlayFrame = String(boss_overlay_frame); if ((presented_frames % 60) === 0) { document.title = 'Tengai - C++/WASM - frame ' + presented_frames; canvas.dataset.frames = String(presented_frames); canvas.dataset.character = String(selected_character); canvas.dataset.countdown = String(countdown); canvas.dataset.playerX = String(player_x); canvas.dataset.playerY = String(player_y); canvas.dataset.playerReady = String(player_ready); } }
function install_input_handlers() { const masks = { left: 0x10, right: 0x20, down: 0x40, up: 0x80, a: 0x01, coin: 0x0100, start: 0x0200, }; const send = (mask, pressed) => { if (Module._tengai_set_input) Module._tengai_set_input(mask, pressed ? 1 : 0); }; const keys = { ArrowLeft: masks.left, ArrowRight: masks.right, ArrowDown: masks.down, ArrowUp: masks.up, KeyZ: masks.a, ShiftLeft: masks.coin, ShiftRight: masks.coin, Enter: masks.start, }; addEventListener('keydown', event => { const mask = keys[event.code]; if (mask === undefined) return; event.preventDefault(); if (!event.repeat) send(mask, true); }, {passive: false}); addEventListener('keyup', event => { const mask = keys[event.code]; if (mask === undefined) return; event.preventDefault(); send(mask, false); }, {passive: false}); const joystick = document.getElementById('joystick'); const knob = document.getElementById('joystick-knob'); const portraitLayout = matchMedia('(orientation: portrait) and (pointer: coarse)'); let activePointer = null; let activeDirections = 0; const updateDirections = next => { for (const mask of [masks.left, masks.right, masks.down, masks.up]) { if ((activeDirections & mask) !== (next & mask)) send(mask, (next & mask) !== 0); } activeDirections = next; }; const moveJoystick = event => { const bounds = joystick.getBoundingClientRect(); const screenDx = event.clientX - (bounds.left + bounds.width / 2); const screenDy = event.clientY - (bounds.top + bounds.height / 2); let dx = portraitLayout.matches ? screenDy : screenDx; let dy = portraitLayout.matches ? -screenDx : screenDy; const radius = bounds.width * 0.31; const length = Math.hypot(dx, dy); if (length > radius) { dx *= radius / length; dy *= radius / length; } knob.style.transform = 'translate(' + dx + 'px,' + dy + 'px)'; const dead = bounds.width * 0.11; let next = 0; if (dx < -dead) next |= masks.left; if (dx > dead) next |= masks.right; if (dy < -dead) next |= masks.up; if (dy > dead) next |= masks.down; updateDirections(next); }; const releaseJoystick = event => { if (activePointer !== event.pointerId) return; activePointer = null; updateDirections(0); knob.style.transform = 'translate(0,0)'; joystick.releasePointerCapture?.(event.pointerId); }; joystick.addEventListener('pointerdown', event => { event.preventDefault(); activePointer = event.pointerId; joystick.setPointerCapture?.(event.pointerId); moveJoystick(event); }, {passive: false}); joystick.addEventListener('pointermove', event => { if (activePointer === event.pointerId) moveJoystick(event); }, {passive: false}); joystick.addEventListener('pointerup', releaseJoystick, {passive: false}); joystick.addEventListener('pointercancel', releaseJoystick, {passive: false}); const action = document.getElementById('action-a'); const releaseAction = event => { event.preventDefault(); send(masks.a, false); }; action.addEventListener('pointerdown', event => { event.preventDefault(); send(masks.a, true); action.setPointerCapture?.(event.pointerId); }, {passive: false}); action.addEventListener('pointerup', releaseAction, {passive: false}); action.addEventListener('pointercancel', releaseAction, {passive: false}); action.addEventListener('lostpointercapture', event => { event.preventDefault(); send(masks.a, false); }, {passive: false}); for (const [id, mask] of [['coin', masks.coin], ['start', masks.start]]) { const button = document.getElementById(id); const release = event => { event.preventDefault(); send(mask, false); }; button.addEventListener('pointerdown', event => { event.preventDefault(); send(mask, true); button.setPointerCapture?.(event.pointerId); }, {passive: false}); button.addEventListener('pointerup', release, {passive: false}); button.addEventListener('pointercancel', release, {passive: false}); button.addEventListener('lostpointercapture', release, {passive: false}); } const releaseAll = () => { activePointer = null; updateDirections(0); knob.style.transform = 'translate(0,0)'; send(masks.a, false); send(masks.coin, false); send(masks.start, false); }; addEventListener('blur', releaseAll); document.addEventListener('visibilitychange', () => { if (document.visibilityState !== 'visible') releaseAll(); }); }
