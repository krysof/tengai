...
// include: C:\Users\kryso\AppData\Local\Temp\tmpbmopmsaf.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'Tengai-0b0831bf.data';
      var REMOTE_PACKAGE_BASE = 'Tengai-0b0831bf.data';
...
Module['FS_createPath']("/", "assets", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['FS_createDataFile'](name, null, data, true, true, true);
          ...
          Module['removeRunDependency']('datafile_Tengai-0b0831bf.data');
      }
      Module['addRunDependency']('datafile_Tengai-0b0831bf.data');
...
function findWasmBinary() {
  return locateFile('Tengai-0b0831bf.wasm');
}
