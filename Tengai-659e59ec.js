...
// include: C:\Users\kryso\AppData\Local\Temp\tmp8117ttou.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'Tengai-659e59ec.data';
      var REMOTE_PACKAGE_BASE = 'Tengai-659e59ec.data';
...
Module['FS_createPath']("/", "assets", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['FS_createDataFile'](name, null, data, true, true, true);
          ...
          Module['removeRunDependency']('datafile_Tengai-659e59ec.data');
      }
      Module['addRunDependency']('datafile_Tengai-659e59ec.data');
...
function findWasmBinary() {
  return locateFile('Tengai-659e59ec.wasm');
}
